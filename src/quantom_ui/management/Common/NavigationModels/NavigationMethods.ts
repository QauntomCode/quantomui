...
import {
  DBClearAllNavigationAction,
  DbInsertNavigationAction,
} from "../../../../IndexedDb/Initialization/Operation/NavigationActionDb";
import { NavigationActionInfo } from "./NavigationAction"; //"./NavigationActionInfo";
...
export const get_all_navigation_data = async () => {
  let data = await QuantomPOST<NavigationActionInfo[]>(
    GET_ALL_NAVIGATION_URL,
    true,
    { MenuCode: "" }
  );
